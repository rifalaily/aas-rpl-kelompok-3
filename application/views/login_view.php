...
<div class="login-box">
    ...
    <form action="<?= base_url('login/auth');?>" method="POST">
      ...
      <div class="row">
        ...
        <div class="col-xs-4">
          ...
          <button type="button" onclick="location.href='<?= base_url('register');?>'" class="btn btn-secondary btn-block btn-flat">Register</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
  ...
  <footer>
    <div class="login-box-body text-center bg-blue">
       <a style="color: yellow;"> Copyright &copy; Sistem Perpustakaan Digital - <?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
